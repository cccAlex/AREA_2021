...
const youtubeDislikeVideo = async (areaID, { serviceParams }, data) => {
    ...
    await axios.post('https://youtube.googleapis.com/youtube/v3/videos/rate?id=' + videoID + '&rating=dislike', {}, {
        headers: { 'Content-Type': 'application/json', 'Authorization': `Bearer ${serviceParams.tokens.access_token}` }
    });
}

module.exports = youtubeDislikeVideo;